package com.xhl.maker.meta;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import com.xhl.maker.meta.enums.FileGenerateTypeEnum;
import com.xhl.maker.meta.enums.FileTypeEnum;
import com.xhl.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "xhl");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.xhl");
